...
int main()
{
    ...
    TXN *stack=(TXN*)malloc(capacity*sizeof(TXN));
    int stack_full(int capacity,int count);
    int stack_empty(int top);
    void push(TXN txn,int *top,TXN *stack,int *count);
        ...
        switch(ch)
        {
            case 1:
                    if(stack_full(capacity,count))
                    {
                        ...
                        stack=(TXN *)realloc(stack,2*capacity*sizeof(TXN));
                        capacity=capacity*2;
